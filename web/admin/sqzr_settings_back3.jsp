                            ...
                            <div id="edit-basic" class="tab-pane active">
                                    ...
                                    <div class="col-xs-12 col-md-8">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label no-padding-right"
                                                   for="form-field-title">网站名称</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label no-padding-right"
                                                   for="form-field-authoremail">作者邮箱</label>

                                            <div class="col-sm-8">
                                                <input class="col-xs-12 col-sm-12" type="text"
                                                       id="form-field-authoremail"
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label no-padding-right"
                                                   for="form-field-subtitle">附标题</label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1 control-label no-padding-right"
                                           for="form-field-weibo">weibo</label>
                            ...
                            <div id="edit-password" class="tab-pane">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right"
                                           for="form-field-reqNewPassword">确认密码</label>
